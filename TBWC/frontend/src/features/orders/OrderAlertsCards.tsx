/**
 * Dashboard cards: 2026 orders missing a PO number, and 2026 orders not yet
 * shipped. Admin-only (mirrors RepInquiriesCard's slot on the dashboard) —
 * /orders is unscoped for admins so a plain fetch here covers every order.
